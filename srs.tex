...
\item A menu with options will be located in the top left corner (Load, Save, About, etc.).
\item A menu that allows the user to change tools.
...
\item Clicking on the About button will open a separate window with a description of the application.
\end{enumerate}
